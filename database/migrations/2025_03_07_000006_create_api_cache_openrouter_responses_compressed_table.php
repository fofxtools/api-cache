...
return new class () extends Migration {
    public function up(): void
    {
        ...
        Schema::create('api_cache_openrouter_responses_compressed', function (Blueprint $table) use ($driver) {
            $table->id();
        ...
        if ($driver === 'mysql') {
            Schema::getConnection()->statement('
                ALTER TABLE api_cache_openrouter_responses_compressed
    ...
    {
        Schema::dropIfExists('api_cache_openrouter_responses_compressed');
    }
};
