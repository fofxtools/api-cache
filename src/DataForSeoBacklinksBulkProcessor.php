...
class DataForSeoBacklinksBulkProcessor
{
    ...
    /**
     * Process all available unprocessed DataForSEO backlinks bulk responses
     *
    ...
    public function processResponsesAll(int $batchSize = 100): array
    {
        ...
        Log::debug('Starting processResponsesAll for DataForSEO backlinks bulk', [
        ...
        while (true) {
            ...
            $cumulativeStats['bulk_items'] += $batchStats['bulk_items'];
            ...
            Log::debug('Processed batch of DataForSEO backlinks bulk responses', [
        ...
        Log::debug('Completed processResponsesAll for DataForSEO backlinks bulk', $cumulativeStats);
