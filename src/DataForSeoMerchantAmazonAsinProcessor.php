...
class DataForSeoMerchantAmazonAsinProcessor
{
    ...
    /**
     * Process all available unprocessed DataForSEO Merchant Amazon ASIN responses
     *
    ...
    public function processResponsesAll(int $batchSize = 100): array
    {
        ...
        Log::debug('Starting processResponsesAll for DataForSEO Merchant Amazon ASIN', [
        ...
        while (true) {
            ...
            Log::debug('Processed batch of DataForSEO Merchant Amazon ASIN responses', [
        ...
        Log::debug('Completed processResponsesAll for DataForSEO Merchant Amazon ASIN', $cumulativeStats);
