...
class DataForSeoSerpGoogleAutocompleteProcessor
{
    ...
    /**
     * Process all available unprocessed DataForSEO SERP Google autocomplete responses
     *
    ...
    public function processResponsesAll(int $batchSize = 100): array
    {
        ...
        Log::debug('Starting processResponsesAll for DataForSEO SERP Google autocomplete', [
        ...
        while (true) {
            ...
            $cumulativeStats['autocomplete_items'] += $batchStats['autocomplete_items'];
            ...
            Log::debug('Processed batch of DataForSEO SERP Google autocomplete responses', [
        ...
        Log::debug('Completed processResponsesAll for DataForSEO SERP Google autocomplete', $cumulativeStats);
